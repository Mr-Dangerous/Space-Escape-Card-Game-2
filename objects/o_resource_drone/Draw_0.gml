...
if (generate_laser = true){
	...
	var _x_offset = x + lengthdir_x(12, laser_direction)
	var _y_offset = y + lengthdir_y(12, laser_direction)
	
	var laser_body_distance = point_distance(_x_offset, _y_offset, target_x, target_y)-12
	var laser_image_x_scale = laser_body_distance/300
